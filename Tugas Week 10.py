...
class BookManager(QMainWindow):
    ...
    def initUI(self):
        ...
        center_form.setAlignment(Qt.AlignTop | Qt.AlignHCenter)
        center_form.addWidget(form_widget)
        center_form.addWidget(simpan_btn)
        data_layout.addLayout(center_form)
        ...
        self.name_label = QLabel("MUHAMMAD FIQRI JORDY ARDIANTO")
        self.nim_label = QLabel("F1D022145")
        self.name_label.setStyleSheet("font-weight: bold; font-size: 16px; font-family: Robboto;")
        self.nim_label.setStyleSheet("font-weight: bold; font-size: 16px; font-family: Robotto;")

        identity_layout = QVBoxLayout()
        identity_layout.setAlignment(Qt.AlignCenter)
        identity_layout.addWidget(self.name_label, alignment=Qt.AlignCenter)
        identity_layout.addWidget(self.nim_label, alignment=Qt.AlignCenter)

        identity_widget = QWidget()
        identity_widget.setLayout(identity_layout)

        data_layout.addWidget(identity_widget, alignment=Qt.AlignCenter)
